...
public class AutoFireState : Istate
{
    ...
    public AutoFireState(StateMachine machine, Animator animator, Player player, Weapon weapon)
    {
    ...
    public void Enter()
    {
        ...
        {
            player.StopCoroutine(AutoShot());
            weapon.curAmmo--;
            player.StartCoroutine(AutoShot());
        }
    }
